...
type Access = { status: string | null; hourly_limit_minutes: number | null; window_used_seconds: number; admin_note: string | null; is_admin: boolean; keys: Key[] };
